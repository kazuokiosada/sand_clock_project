...
#チェックポイント
t3=V3/p3*click ###=tcn*click=time_full*cn*click=60*cycle*cn*click=60*cycle
t1=V1/V3*t3
t2=V2/V3*t3
t4=t3
...
# グラデーションの色
###color1 = (238, 130, 238)  # 鮮やかな紫
color1 = (250, 150, 250)  # 鮮やかな薄紫
###color1=adjust_saturation_hsv((0,0,255),1.0)
color2=(150,80,150)###暗い薄紫
###color2=adjust_saturation_hsv(color1,0.5)
...
class SandTimer(QWidget):
    def __init__(self):
        ...
        self.initTimer()
        ###
        ###print("V3 p3 tcn t1,t2 t3",V3,p3,tcn,t1,t2,t3)
